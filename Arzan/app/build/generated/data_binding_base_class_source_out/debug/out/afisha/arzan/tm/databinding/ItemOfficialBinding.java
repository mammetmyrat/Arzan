...
public final class ItemOfficialBinding implements ViewBinding {
  @NonNull
  ...
  private ItemOfficialBinding(@NonNull ConstraintLayout rootView, @NonNull TextView about,
  ...
  @NonNull
  public static ItemOfficialBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemOfficialBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_official, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemOfficialBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemOfficialBinding((ConstraintLayout) rootView, about, follow, followBtn,
          userimage, username);
    }
