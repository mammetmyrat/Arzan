...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView badgeNotify;
  ...
  private FragmentHomeBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout appBar,
      @NonNull ImageView badgeNotify, @NonNull MaterialCardView bannerCard,
      ...
      @NonNull MaterialCardView notification, @NonNull MaterialCardView official,
      @NonNull ProgressBar progress, @NonNull MaterialCardView region, @NonNull TextView regionText,
      @NonNull RecyclerView rvPosts, @NonNull RecyclerView rvVip,
      @NonNull MaterialCardView statistic, @NonNull SwipeRefreshLayout swipeRefresh,
      @NonNull Toolbar toolbar, @NonNull ImageView typeIcon, @NonNull TextView viewAll,
      @NonNull ViewPager viewPager, @NonNull MaterialCardView viewType,
      @NonNull RelativeLayout vipline) {
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.badge_notify;
      ImageView badgeNotify = rootView.findViewById(id);
      if (badgeNotify == null) {
        break missingId;
      }
      ...
      return new FragmentHomeBinding((CoordinatorLayout) rootView, appBar, badgeNotify, bannerCard,
          collapsingToolbarLayout, coordinator, dot, icon, mainCard, nested, notification, official,
          progress, region, regionText, rvPosts, rvVip, statistic, swipeRefresh, toolbar, typeIcon,
          viewAll, viewPager, viewType, vipline);
    }
