...
public final class ActivityLinkPostActivtiyBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityLinkPostActivtiyBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityLinkPostActivtiyBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLinkPostActivtiyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_link_post_activtiy, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLinkPostActivtiyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLinkPostActivtiyBinding((ConstraintLayout) rootView, cardTop, cardTop1,
          countsLine, createdAt, description, dot, fav, like, likeCount, line, line2, line3, line5,
