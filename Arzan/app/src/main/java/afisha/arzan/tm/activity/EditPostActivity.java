...
public class EditPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RegionAdapter adapter = new RegionAdapter(EditPostActivity.this, Global.regions);
        ...
        imagesAdapter.setType(0);
        try {
            imagesAdapter.setOldImages(Global.post.getImages());
    ...
    private void selectImageFromGallery() {
        ImagesAdapter imagesAdapter = new ImagesAdapter(context);
        TedBottomPicker.with(EditPostActivity.this)
                .setPeekHeight(1600)
                .setSelectMaxCount(5)
                .showTitle(false)
    ...
    private void postPost() {
        ...
        call.enqueue(new Callback<StandardResponse>() {
            ...
            public void onFailure(Call<StandardResponse> call, Throwable t) {
                loading.dismiss();
                Toast.makeText(EditPostActivity.this, getResources().getString(R.string.network_error_toast), Toast.LENGTH_SHORT).show();
